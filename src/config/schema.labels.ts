...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "models.providers.*.wsUrl": "Model Provider WebSocket URL",
  "models.providers.*.wsHeaders": "Model Provider WebSocket Headers",
  "models.providers.*.responsesGateway": "Model Provider Responses Gateway",
