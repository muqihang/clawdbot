...
const runGate2 = async (): Promise<void> => {
  ...
  const defaultDatasetPath = path.join(gate2Dir, "inputs", "retrieval-dataset.v2.json");
  ...
  const report: Gate2Report = {
    ...
    changed_files: [
      ...
      "analysis/2026-02-24-mem0-graphiti-value-maximization/wave2-artifacts/day13/w2-step3-query-construction/run-w2-gate2-eval.ts",
    ],
